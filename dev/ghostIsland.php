...
<header id="topHeader">
    <div id="navStatus">
        ...
        <div id="memStatus">
            <p><img id="memName" src="./img/login/" /></p>
        ...
        <section id="login_page2" style="display: none;">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="user_border">
                    <div id="user_path"></div>
                    <label for="user_img"
                        >上傳封面<input type="file" name="userimg" id="user_img" style="display: none;"
                    /></label>
                </div>
                <p>
            ...
            <script>
                ...
                let user_img = $id("user_img")
                let user_path = $id("user_path")

                user_img.addEventListener("change", function() {
                    var file = user_img.files[0]
                    var filereader = new FileReader()
                    filereader.readAsDataURL(file)
                    filereader.addEventListener("load", function(e) {
                        user_path.style.backgroundImage = `url(${e.target.result})`
                    })
                    $(this)
                        .parent()
