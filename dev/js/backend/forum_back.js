    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (admin == 1) {
                for (i = 0; i < data.length; i++) {
                    ...
                    <td>
                      <label class="switch switch-3d switch-success">
                          <input class="switch-input question_status modified" type="checkbox" name="question_status" value="1" style="border: 1px solid rgb(204, 204, 204);" psn="${data[i].forum_no}" checked  disabled>
                          <span class="switch-slider"></span>
                      </label>
                    </td>
                    <td>
                      <button type="button" class="btn btn-secondary btn-danger" data-dismiss="modal" no="${data[i].mem_no}" psn="${data[i].forum_report_no}" disabled>刪除</button>
                    ...
                    <td>${data[i].forum_title}</td>
                    <td><img src="./php/images/${data[i].images}" style="width:100px"></td>
                    <td>${data[i].mem_name_name}</td>
                    <td>${data[i].forum_report_reason}</td>
                    <td>
                      <label class="switch switch-3d switch-success">
                          <input class="switch-input question_status modified" type="checkbox" name="question_status" value="1" style="border: 1px solid rgb(204, 204, 204);" psn="${data[i].forum_no}" disabled>
                          <span class="switch-slider"></span>
                      </label>
                    </td>
                    <td>
                ...
                <td>
                  <button type="button" class="btn btn-secondary btn-danger" data-dismiss="modal" no="${data[i].mem_no}" psn="${data[i].forum_report_no}">刪除</button>
